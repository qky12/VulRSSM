...
class Dreamer:
    ...
    def _model_update(self, data, posterior_info):
        ...
        self.writer.add_scalar("model_loss", model_loss, self.num_total_episode)
    ...
    def _agent_update(self, behavior_learning_infos):
        ...
        self.writer.add_scalar("actor_loss", actor_loss, self.num_total_episode)
        ...
        self.writer.add_scalar("value_loss", value_loss, self.num_total_episode)
